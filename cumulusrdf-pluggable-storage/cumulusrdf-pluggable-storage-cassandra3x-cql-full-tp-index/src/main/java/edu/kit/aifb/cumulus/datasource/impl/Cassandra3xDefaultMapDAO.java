 ...
 */
class Cassandra3xDefaultMapDAO<K, V> implements MapDAO<K, V> {
	 ...
	 */
	public Cassandra3xDefaultMapDAO(final Session session, final Serializer<K> keySerializer, final Serializer<V> valueSerializer) {
	 ...
	 * @param valueSerializer The serializer for the values.
	 */
	public Cassandra3xDefaultMapDAO(final Session session, final String tableName, final Serializer<K> keySerializer, final Serializer<V> valueSerializer) {
	 ...
	 * @param valueSerializer The serializer for the values.
	 */
	public Cassandra3xDefaultMapDAO(final Session session, final String tableName, final boolean bidirectional, final Serializer<K> keySerializer,
	 ...
	 * @param valueSerializer The serializer for the values.
	 */
	public Cassandra3xDefaultMapDAO(
