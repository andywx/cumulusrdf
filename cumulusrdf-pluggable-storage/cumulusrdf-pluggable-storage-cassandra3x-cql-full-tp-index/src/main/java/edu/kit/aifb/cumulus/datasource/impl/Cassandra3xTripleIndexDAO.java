...
import static edu.kit.aifb.cumulus.datasource.impl.Cassandra3xConstants.EMPTY_VAL;
...
/**
 * Cassandra 3x (CQL-based) implementation of {@link TripleIndexDAO}.
 * 
 * @author Sebastian Schmidt
 * @author Andrea Gazzarini
 * @since 1.1.0
 */
public class Cassandra3xTripleIndexDAO implements TripleIndexDAO {
	 ...
	 */
	Cassandra3xTripleIndexDAO(final CumulusDataAccessLayerFactory factory, final ITopLevelDictionary dictionary) {
		_factory = factory;
