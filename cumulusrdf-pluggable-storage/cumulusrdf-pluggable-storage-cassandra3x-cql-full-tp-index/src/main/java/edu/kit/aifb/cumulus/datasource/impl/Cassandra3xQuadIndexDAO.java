 ...
 * @since 1.1.0
 */
public class Cassandra3xQuadIndexDAO extends Cassandra3xTripleIndexDAO implements QuadIndexDAO {
	 ...
	 */
	Cassandra3xQuadIndexDAO(final CumulusDataAccessLayerFactory factory, final ITopLevelDictionary dictionary) {
