 ...
 */
class Cassandra3xBidirectionalMapDAO<K, V> implements MapDAO<K, V> {

	private static final Log LOG = new Log(LoggerFactory.getLogger(Cassandra3xBidirectionalMapDAO.class));
	 ...
	 */
	Cassandra3xBidirectionalMapDAO(final Session session, final String tableName, final Serializer<K> keySerializer, final Serializer<V> valueSerializer) {
	 ...
	 * @param valueSerializer The serializer for the values.
	 */
	public Cassandra3xBidirectionalMapDAO(final Session session, final String tableName,
